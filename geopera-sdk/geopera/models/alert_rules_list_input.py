...
T = TypeVar("T", bound="AlertRulesListInput")


@_attrs_define
class AlertRulesListInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_rules_list_input = cls(
            active=active,
            collection_id=collection_id,
        )

        alert_rules_list_input.additional_properties = d
        return alert_rules_list_input
