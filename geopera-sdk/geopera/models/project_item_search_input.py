...
if TYPE_CHECKING:
    from ..models.project_item_search_input_query_type_0 import ProjectItemSearchInputQueryType0
    from ..models.project_item_search_input_sortby_type_0_item import ProjectItemSearchInputSortbyType0Item


T = TypeVar("T", bound="ProjectItemSearchInput")


@_attrs_define
class ProjectItemSearchInput:
    """
    Attributes:
        project_id (str):
        ...
        query (None | ProjectItemSearchInputQueryType0 | Unset):
        sortby (list[ProjectItemSearchInputSortbyType0Item] | None | Unset):
        format_ (None | str | Unset): 'stac' for full STAC features
        base_url (None | str | Unset): Base URL for STAC links (stac format only)
    """
    ...
    query: None | ProjectItemSearchInputQueryType0 | Unset = UNSET
    sortby: list[ProjectItemSearchInputSortbyType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.query, Unset):
            query = UNSET
        elif isinstance(self.query, ProjectItemSearchInputQueryType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_query(data: object) -> None | ProjectItemSearchInputQueryType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                query_type_0 = ProjectItemSearchInputQueryType0.from_dict(data)

                return query_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectItemSearchInputQueryType0 | Unset, data)

        query = _parse_query(d.pop("query", UNSET))

        def _parse_sortby(data: object) -> list[ProjectItemSearchInputSortbyType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for sortby_type_0_item_data in _sortby_type_0:
                    sortby_type_0_item = ProjectItemSearchInputSortbyType0Item.from_dict(sortby_type_0_item_data)
                ...
                pass
            return cast(list[ProjectItemSearchInputSortbyType0Item] | None | Unset, data)
        ...
        project_item_search_input.additional_properties = d
        return project_item_search_input
