...
T = TypeVar("T", bound="ProjectArchiveInput")


@_attrs_define
class ProjectArchiveInput:
    """
    Attributes:
        project_id (str):
        name (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_archive_input.additional_properties = d
        return project_archive_input
