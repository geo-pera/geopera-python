...
T = TypeVar("T", bound="ShareTilejsonInput")


@_attrs_define
class ShareTilejsonInput:
    """
    Attributes:
        token (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        share_tilejson_input = cls(
            token=token,
            password=password,
            profile=profile,
        )

        share_tilejson_input.additional_properties = d
        return share_tilejson_input
