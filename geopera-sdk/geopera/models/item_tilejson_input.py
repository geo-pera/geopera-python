...
T = TypeVar("T", bound="ItemTilejsonInput")


@_attrs_define
class ItemTilejsonInput:
    """
    Attributes:
        item_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_tilejson_input = cls(
            item_id=item_id,
            profile=profile,
            asset_key=asset_key,
        )

        item_tilejson_input.additional_properties = d
        return item_tilejson_input
